    ...
    Producto arrProds[CANT_PRODS] =
        {
            ...
            {"10", "Ar�ndano", 60.50, {2, 10, 2022}, 30},
    ...
    Producto arrProds[CANT_PRODS] =
        {
            ...
            {"07", "Pera", 50.50, {5, 9, 2020}, 50},
            {"09", "Manzana", 70.50, {28, 4, 2022}, 70},
            {"10", "Arandano", 60.50, {2, 10, 2022}, 30},
            {"14", "Durazno", 90.50, {15, 4, 2020}, 90}};
    ...
    Empleado vEmpleados[] =
        {
            ...
            {56789012, "Martina", "Fern�ndez", 75000},
            {56789012, "Ana", "G�mez", 75000},
            {12345678, "Juan", "G�mez", 360000},
            {78901234, "Facundo", "Gonz�lez", 200000},
            {34567890, "Belen", "Guti�rrez", 300000},
            {34567890, "Sofia", "Guti�rrez", 95000},
    ...
    Estudiante vEstudiantes[] =
        {
            ...
            {56789012, "Martina", "Fern�ndez", 8},
            {56789012, "Ana", "G�mez", 6.75},
            {12345678, "Gaston", "G�mez", 4.25},
            {22222222, "Facundo", "Gonz�lez", 2},
            {11111111, "Camila", "Guti�rrez", 8.50},
            {66666666, "Lucia", "Guti�rrez", 7.25},
...
Ambos archivos estan ordenados alfabeticamente por <apellido> / <nombre> /
<dni>. Ambos archivos deben ser leidos solo una vez, y no deben ser almacenados en
...
int txtVarABin(const char* linea, Producto* prod) {
    ...
    // En el caso de que el tama�o de la linea es menor que el registro no lo va a encontrar
    if (!act)
    ...
    *act = '\0';
    ...
    // Este control es por si copio mas del tama�o de la descripcion, entonces se pone un '\0' al final
