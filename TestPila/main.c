...
/*Ejercicio 10: Resuelva el c�lculo de la suma de dos n�meros enteros de muchos d�gitos (30 o
muchos m�s) haciendo uso de dos pilas en las que almacena s�lo los d�gitos. Tenga en
cuenta que debe utilizar una tercera pila en la que ir� cargando los resultados parciales.
Compruebe que obtiene id�nticos resultados con ambas implementaciones de
Pila (est�tica y din�mica)*/
...
/*6 - Pasar el primer elemento de la Pila1 a su �ltima posici�n, dejando los restantes en el mismo orden.*/
...
/*7 - Pasar el �ltimo elemento de la Pila1 a su primera posici�n, dejando los restantes en el mismo orden.*/
void ponerElementoTopeAlPrincipio(Pila* pila) {
