...
int main()
{
    ...
    char frase[TAM_TEXTO] = "En muchas partes del cuerpo como son las manos, las orejas o los pies, están "
                            "representados todos los órganos y partes del cuerpo. Incidiendo sobre estas "
                            "zonas se pueden crear arcos reflejos que actúen directamente sobre cualquier "
                            "órgano del cuerpo y que solucionen cualquier anomalía que exista. En las "
                            "manos, las orejas o los pies, se representan todos los órganos del cuerpo."
                            "Incidiendo sobre estas zonas se pueden crear arcos reflejos que actúen "
                            "directamente sobre cualquier punto del organismo y que solucionan cualquier "
                            "punto del organismo y que solucionen la anomalía que exista.";
    int top;
