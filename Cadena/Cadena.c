...
/*Realizar una funcion que reemplace dentro de una cadena una subcadena por otra.*/
...
/*Ejercicio 27: Desarrollar una funci�n que determine si una cadena de caracteres
es un pal�ndromo.*/
...
/*Ejercicio 28: Desarrollar una funci�n que devuelva el valor num�rico de una
cadena de caracteres (asumiendo que los caracteres representan d�gitos).*/
...
'.' (o en su defecto en car�cter nulo -'\0'-), escriba un programa en que determine e informe:
