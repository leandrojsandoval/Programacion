...
#define ES_TILDE_MINUSCULA(X) ((X) == '�' || (X) == '�' || (X) == '�' || (X) == '�' || (X) == '�')
#define ES_DIERESIS_MINUSCULA(X) ((X) == '�' || (X) == '�' || (X) == '�' || (X) == '�' || (X) == '�')
#define ES_BLANCO(X) ((X) == ' ' || (X) == '\n' || (X) == '\t')

#define ES_MAYUSCULA(X) ((X) >= 'A' && (X) <= 'Z')
#define ES_TILDE_MAYUSCULA(X) ((X) == '�' || (X) == '�' || (X) == '�' || (X) == '�' || (X) == '�')
#define ES_DIERESIS_MAYUSCULA(X) ((X) == '�' || (X) == '�' || (X) == '�' || (X) == '�' || (X) == '�')
...
#define MI_TOUPPER(X) ((ES_MINUSCULA(X) || ES_TILDE_MINUSCULA(X) || ES_DIERESIS_MINUSCULA(X) || (X) == '�') ? ((X)-OFFSET_ASCII) : (X))
/// Convierte un caracter en mayuscula a minuscula
#define MI_TOLOWER(X) ((ES_MAYUSCULA(X) || ES_TILDE_MAYUSCULA(X) || ES_DIERESIS_MAYUSCULA(X) || (X) == '�') ? ((X) + OFFSET_ASCII) : (X))
